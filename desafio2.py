...
if login == usuario['login'] and senha == usuario['senha']:
    ...
    clientes2['nome'] = input('Digite seu nome: ')
    clientes2['idade'] = int(input('Digite sua idade: '))
    print('******************************************')

    clientes3['nome'] = input('Digite seu nome: ')
    clientes3['idade'] = int(input('Digite sua idade: '))
    print('******************************************')
    ...
    tipo_quarto_cliente1 = input(f"\n{clientes['nome']}, escolha o tipo de quarto (Simples, Duplo, Luxo): ").lower()
    dias_cliente1 = int(input(f"Quantos dias você ficará no hotel, {clientes['nome']}?: "))
    ...
    tipo_quarto_cliente2 = input(f"\n{clientes2['nome']}, escolha o tipo de quarto (Simples, Duplo, Luxo): ").lower()
    dias_cliente2 = int(input(f"Quantos dias você ficará no hotel, {clientes2['nome']}?: "))
    ...
    tipo_quarto_cliente3 = input(f"\n{clientes3['nome']}, escolha o tipo de quarto (Simples, Duplo, Luxo): ").lower()
    dias_cliente3 = int(input(f"Quantos dias você ficará no hotel, {clientes3['nome']}?: "))
